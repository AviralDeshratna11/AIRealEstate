  ...
  return (
    <main className="min-h-screen p-4 text-ink md:p-8">
      <div className="mx-auto max-w-5xl">
        ...
        <section className="grid gap-4 rounded-lg border border-ink/15 bg-[#f9fafb]/92 p-5 shadow-soft sm:grid-cols-2">
          ...
          <button className="h-11 rounded-md bg-ink px-4 text-sm font-black text-[#f9fafb] hover:bg-teal sm:col-span-2">Save profile</button>
        </section>
      </div>
    </main>
  );
